#   Para manipular baixar e gerenciar formatos JSON
#   Utilizamos a biblioteca chamada JSON
...
# Converter esse dicionario em um arquivo JSON 
# Vamos manipular ulilizando a função JSON.DUMP

dados = json.dumps(cadastro_pessoas,indent=4)
with open('arquivos/pessoas.json','w+') as j:
    json.dump(cadastro_pessoas,j,indent=4)

# Abrir o arquivo com o json joads para um dicionario
